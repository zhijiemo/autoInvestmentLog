...
try:
    ...
    df_Stock.to_excel(localtime + '/A_data.xls')
...
try:
    ...
    df_Future_C.to_excel(localtime + '/Future_C_data.xls')
except:
    pass
...
try:
    ...
    df_Future_F.to_excel(localtime + '/Future_F_data.xls')
except:
    pass
...
try:
    ...
    df_Future_W.to_excel(localtime + '/Future_W_data.xls')
except:
    pass
...
try:
    ...
    for key, value in df_Shibor.items():
        value.to_excel(localtime + '/Shibor_' + key + '.xls')
except:
    pass
...
try:
    ...
    for key, value in df_Libor.items():
        value.to_excel(localtime + '/Libor_' + key + '.xls')
except:
    pass
